...
import com.ozyern.skin.util.EditTextExtensions;
...
public class Folder extends AbstractFloatingView implements ClipPathView, DragSource,
    ...
    protected void onFinishInflate() {
        ...
        mBackground.setColor(SkinUtilsKt.resolveFolderBackgroundColor(getContext()));
        var alpha = SkinUtilsKt.getFolderBackgroundAlpha(getContext());
    ...
    /**
     * LC: App drawer folders live in Skin's own database and are not part of the
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        // Skin-TODO: Keyboard too close to Folder name edit?
