package com.ozyern.skin.ui.popup
...
import com.ozyern.skin.override.CustomizeAppDialog
...
import com.ozyern.skin.ui.preferences.navigation.AppDrawerAppListToFolder
import com.ozyern.skin.views.ComposeBottomSheet
...
class SkinShortcut {
    ...
    companion object {
        ...
        fun showAppDrawerFolderPopup(
            ...
            // SkinFolderShortcut.kt
            return OptionsPopupView.show<SkinLauncher>(
                launcher,
                RectF(bounds),
                listOf(
        ...
        val CUSTOMIZE =
            SystemShortcut.Factory { activity: SkinLauncher, itemInfo, originalView ->
        ...
        private fun getAppInfo(launcher: SkinLauncher, itemInfo: ItemInfo): ModelAppInfo? {
        ...
        val PAUSE_APPS = SystemShortcut.Factory { activity: SkinLauncher, itemInfo: ItemInfo, originalView: View ->
    ...
    class Customize(
        private val launcher: SkinLauncher,
        private val appInfo: ModelAppInfo,
        itemInfo: ItemInfo,
        originalView: View,
    ) : SystemShortcut<SkinLauncher>(R.drawable.ic_edit, R.string.action_customize, launcher, itemInfo, originalView) {
            ...
            AlertDialog.Builder(context)
                ...
                .setPositiveButton(R.string.pause) { _, _ ->
                    try {
                        ...
                        Log.e("SkinShortcut", "Failed to pause app", e)
                    }
                }
                .show()
