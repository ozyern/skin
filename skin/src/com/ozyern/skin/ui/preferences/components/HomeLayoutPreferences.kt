...
import com.ozyern.skin.ui.preferences.components.controls.SwitchPreferenceWithPreview
...
fun HomeLayoutSettings(
    ...
    val deckManager = remember { SkindeckManager(context) }
    ...
    if (isLoading) {
        AlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(R.string.home_skin_deck_label_beta),
    ...
    SwitchPreferenceWithPreview(
            ...
            if (newValue) {
                coroutineScope.launch {
                    ...
                    withContext(Dispatchers.IO) {
                        deckManager.enableSkindeck { message ->
        ...
        enabledLabel = stringResource(R.string.home_skin_deck_label_beta),
        enabledContent = {
            PreviewLayout(
                topQsb = false,
                loading = isLoading,
