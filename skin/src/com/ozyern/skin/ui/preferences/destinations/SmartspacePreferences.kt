...
import com.ozyern.skin.smartspace.SmartspaceViewContainer
...
import com.ozyern.skin.smartspace.model.Smartspacer
...
fun SmartspacePreferences(
    ...
    val modeIsSkin = selectedMode == SkinSmartspace
    ...
    PreferenceLayout(
        ...
        if (fromWidget) {
            SmartspacePreview()
            SkinSmartspaceSettings(smartspaceProvider)
        } else {
            MainSwitchPreference(
                adapter = smartspaceAdapter,
                label = stringResource(R.string.smartspace_widget_toggle_label),
                description = stringResource(id = R.string.smartspace_widget_toggle_description).takeIf { modeIsSkin },
            ) {
                if (modeIsSkin) {
                    SmartspacePreview()
                }
...
@Composable
private fun SkinSmartspaceSettings(
