...
import com.ozyern.skin.ui.preferences.components.FeedPreference
import com.ozyern.skin.ui.preferences.components.GestureHandlerPreference
import com.ozyern.skin.ui.preferences.components.HomeLayoutSettings
import com.ozyern.skin.ui.preferences.components.NavigationActionPreference
import com.ozyern.skin.ui.preferences.components.OverlayHandlerPreference
...
import com.ozyern.skin.ui.preferences.navigation.HomeScreenGrid
import com.ozyern.skin.util.collectAsStateBlocking
...
fun HomeScreenPreferences(
    ...
    PreferenceLayout(
        ...
        PreferenceGroup(heading = stringResource(id = R.string.status_bar_label)) {
            ...
            ExpandAndShrink(visible = showStatusBarAdapter.state.value && SkinApp.isRecentsEnabled) {
                SwitchPreference(
