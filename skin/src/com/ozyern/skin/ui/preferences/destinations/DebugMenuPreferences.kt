...
import com.ozyern.skin.ui.preferences.components.controls.TextPreference
...
import com.ozyern.skin.ui.preferences.navigation.FeatureFlags
    ...
    PreferenceLayout(
        ...
        MainSwitchPreference(adapter = enableDebug, label = "Show debug menu") {
                    ...
                    onClick = {
                        try {
                            ...
                            /* This is really unlikely, we are just highlighting the option,
                                not directly opening like Skin 14 and older unless they
            ...
            PreferenceGroup(heading = "Debug flags") {
                ...
                // Codename for Skin to intentionally omit version number from the public,
            ...
            PreferenceGroup(heading = "Smartspace Onboarding") {
                ...
                ClickablePreference(
                    label = "Reset open skin settings",
