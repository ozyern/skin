package com.ozyern.skin.qsb.providers
...
import com.ozyern.skin.qsb.ThemingMethod
import com.ozyern.skin.resolveIntent
    ...
    companion object {
        ...
        fun resolveDefault(context: Context): QsbSearchProvider {
            ...
            val isDefaultProviderIntentResolved =
                SkinQsbLayout.resolveIntent(context, defaultProvider.createSearchIntent())
            ...
            return values()
                ...
                .firstOrNull { SkinQsbLayout.resolveIntent(context, it.createSearchIntent()) }
                ?: AppSearch
        }
    }
}
