...
import com.ozyern.skin.icons.picker.IconType
import com.ozyern.skin.preferences.PreferenceManager
import com.ozyern.skin.util.MultiSafeCloseable
...
class SkinIconProvider @Inject constructor(
    ...
    override fun getThemedIconMap(): MutableMap<String, ThemeData> {
        ...
        // first, get Skin's internal grayscale icon map
    ...
    companion object {
        const val TAG = "SkinIconProvider"
    }
}
