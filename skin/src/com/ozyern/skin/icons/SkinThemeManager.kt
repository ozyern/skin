...
import com.ozyern.skin.icons.shape.PathShapeDelegate
import com.ozyern.skin.preferences.PreferenceChangeListener
...
constructor(
    ...
    init {
        val scope = MainScope() + CoroutineName("SkinThemeManager")
        merge(
...
private const val TAG = "SkinThemeManager"
