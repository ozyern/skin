 ...
 * them to [SkinPredictionStore] depending on where the app is launched from.
 *
 ...
 * to [UsageStatsRanker], and target compilation to [SkinPredictionEngine].
 */
class SkinAppPredictor(private val context: Context) : StatsLogCompatManager.StatsLogConsumer {

    private val userCache = UserCache.INSTANCE.get(context)
    private val predictionManager = SkinPredictionManager.getInstance(context)
    ...
    private val predictionEngine = SkinPredictionEngine(context, usageStatsRanker)
