 ...
 *
 * Exposes three [SkinPredictionStore] for hotseat, allapps usage, and dismissed apps.
 */
@LauncherAppSingleton
class SkinPredictionManager @Inject constructor(
    ...
    companion object {
        ...
        private val Context.predictionDataStore by preferencesDataStore(
            name = "skin-predictions",
        )

        @JvmField
        val INSTANCE = DaggerSingletonObject(LauncherAppComponent::getSkinPredictionManager)
    ...
    val hotseatStore = SkinPredictionStore(
    ...
    val allAppsStore = SkinPredictionStore(
        preference = preference(
    ...
    val dismissedAppsStore = SkinPredictionStore(
        preference = preference(
