...
object SkinLockedStateController {

    private const val TAG = "SkinLockedStateController"
    ...
    private val backgroundThread: HandlerThread by lazy {
        HandlerThread("Recents-SkinLockedStateController", 10)
    }
    ...
    fun initialize(context: Context): SkinLockedStateController {
