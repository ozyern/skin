...
class SkinFloatingSurfaceView @JvmOverloads constructor(
    context: Context?,
    ...
    private val mLauncher: SkinLauncher = context!!.launcher
    ...
    private fun getBackgroundAnimator(): ObjectAnimator {
        ...
        val targetDepth = mLauncher.stateManager.state.getDepth<SkinLauncher?>(mLauncher)
    ...
    companion object {
         ...
         */
        fun show(launcher: SkinLauncher, contract: GestureNavContract?) {
            val view: SkinFloatingSurfaceView =
