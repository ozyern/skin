package com.ozyern.skin.backup
...
import com.ozyern.skin.SkinProto.BackupInfo
import com.ozyern.skin.util.hasFlag
import com.ozyern.skin.util.scaleDownTo
import com.ozyern.skin.util.scaleDownToDisplaySize
...
class SkinBackup(
    ...
    companion object {
        ...
        fun generateBackupFileName(): String {
            val fileName = "Skin_Backup ${SimpleDateFormat.getDateTimeInstance().format(Date())}"
            return "$fileName.skinbackup"
        }
        ...
        suspend fun create(context: Context, contents: Int, screenshotBitmap: Bitmap, fileUri: Uri) {
            ...
            val info = BackupInfo.newBuilder()
                .setSkinVersion(BuildConfig.VERSION_CODE)
