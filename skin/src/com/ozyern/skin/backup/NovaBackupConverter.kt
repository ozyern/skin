...
class NovaBackupConverter(
    ...
    suspend fun convertAndRestore(info: NovaBackupInfo) = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            writeGridToSkinPrefs(info)

            val restoredDbFile = context.getDatabasePath(SkinBackup.RESTORED_DB_FILE_NAME)
    ...
    private fun writeGridToSkinPrefs(info: NovaBackupInfo) {
    ...
    private fun insertNovaItems(
        ...
        src.rawQuery(
            ...
            while (cursor.moveToNext()) {
                ...
                /* TODO: Skin folder synchronization support
                 *        For nova parity:
