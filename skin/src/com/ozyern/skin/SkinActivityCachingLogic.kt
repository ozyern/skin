...
private const val TAG = "SkinActivityCachingLogic"

@LauncherAppSingleton
class SkinActivityCachingLogic @Inject constructor(
    ...
    companion object {
        @JvmField
        val INSTANCE = DaggerSingletonObject(LauncherAppComponent::getSkinActivityCachingLogic)
    }
}
