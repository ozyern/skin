...
package com.ozyern.skin.preferences2
...
import com.ozyern.skin.data.Converters
...
import com.ozyern.skin.preferences.PreferenceManager as SkinPreferenceManager
import com.ozyern.skin.qsb.providers.QsbSearchProvider
import com.ozyern.skin.search.algorithms.SkinSearchAlgorithm
import com.ozyern.skin.search.algorithms.engine.provider.web.WebSearchProvider
import com.ozyern.skin.smartspace.model.SmartspaceCalendar
import com.ozyern.skin.smartspace.model.SmartspaceMode
import com.ozyern.skin.smartspace.model.SmartspaceTimeFormat
...
import com.ozyern.skin.ui.popup.toOptionOrderString
import com.ozyern.skin.ui.preferences.components.HiddenAppsInSearch
import com.ozyern.skin.ui.preferences.data.liveinfo.LiveInformationManager
import com.ozyern.skin.util.kotlinxJson
import com.ozyern.skin.views.overlay.FullScreenOverlayMode
...
class PreferenceManager2 @Inject constructor(
    ...
    val skinPredictorUseWeightedUsageStats = preference(
        key = booleanPreferencesKey(name = "skin_prediction_use_weighted_usage"),
        defaultValue = false,
    )
    ...
    val searchAlgorithm = preference(
        ...
        defaultValue = SkinSearchAlgorithm.LOCAL_SEARCH,
        onSet = { reloadHelper.recreate() },
    )
    ...
    val enableFontSelection = preference(
        ...
        onSet = { newValue ->
            if (!newValue) {
                ...
                SkinPreferenceManager.getInstance(context).fontWorkspace.set(newValue = fontCache.uiText)
            }
        },
    )
    ...
    val deckLayout = preference(
        key = booleanPreferencesKey(name = "enable_skin_deck"),
        defaultValue = false,
