package com.ozyern.skin.allapps
...
import com.ozyern.skin.qsb.SkinQsbLayout.Companion.getLensIntent
import com.ozyern.skin.qsb.SkinQsbLayout.Companion.getSearchProvider
import com.ozyern.skin.qsb.SkinQsbLayout.Companion.getVoiceIntent
import com.ozyern.skin.qsb.SkinQsbUi
import com.ozyern.skin.qsb.QsbActions
import com.ozyern.skin.qsb.QsbIconId
...
import com.ozyern.skin.qsb.rememberAllAppsQsbState
import com.ozyern.skin.search.SkinRecentSuggestionProvider
...
class AllAppsSearchInput(context: Context, attrs: AttributeSet?) :
    ...
    private lateinit var apps: SkinAlphabeticalAppsList<*>
    private lateinit var appsView: ActivityAllAppsContainerView<*>
    private var searchAlgorithm: SkinSearchAlgorithm? = null
    ...
    private val suggestionsRecent = SearchRecentSuggestions(launcher, SkinRecentSuggestionProvider.AUTHORITY, SkinRecentSuggestionProvider.MODE)
    ...
    override fun onFinishInflate() {
        ...
        input.onFocusChangeListener = { _, hasFocus ->
            if (hasFocus) {
                if (prefs2.searchAlgorithm.firstCached() != SkinSearchAlgorithm.APP_SEARCH) {
        ...
        input.addTextChangedListener(
            ...
            afterTextChanged = {
                ...
                if (input.text.toString() == "/skindebug") {
    ...
    override fun initializeSearch(appsView: ActivityAllAppsContainerView<*>) {
        apps = appsView.searchResultList as SkinAlphabeticalAppsList<*>
        this.appsView = appsView
        val algorithm = SkinSearchAlgorithm.create(context)
