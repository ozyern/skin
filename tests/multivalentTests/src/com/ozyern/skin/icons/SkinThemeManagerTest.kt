...
class SkinThemeManagerTest {
    ...
    @Before
    fun setUp() {
        context.initDaggerComponent(DaggerSkinThemeManagerTestComponent.builder())
...
interface SkinThemeManagerTestComponent : LauncherAppComponent {
    ...
    interface Builder : LauncherAppComponent.Builder {
        ...
        override fun build(): SkinThemeManagerTestComponent
    }
}
